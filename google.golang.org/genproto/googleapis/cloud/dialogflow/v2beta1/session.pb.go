...
func (AudioEncoding) EnumDescriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func (*DetectIntentRequest) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func (*DetectIntentResponse) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{1} }
...
func (*QueryParameters) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{2} }
...
func (*QueryInput) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{3} }
...
func (*QueryResult) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{4} }
...
func (*StreamingDetectIntentRequest) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{5} }
...
func (*StreamingDetectIntentResponse) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{6} }
...
func (*StreamingRecognitionResult) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{7} }
...
func (*InputAudioConfig) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{8} }
...
func (*TextInput) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{9} }
...
func (*EventInput) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{10} }
...
func init() { proto.RegisterFile("google/cloud/dialogflow/v2beta1/session.proto", fileDescriptor5) }
