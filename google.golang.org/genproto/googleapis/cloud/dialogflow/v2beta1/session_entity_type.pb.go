...
func (*SessionEntityType) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*ListSessionEntityTypesRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{1} }
...
func (*ListSessionEntityTypesResponse) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{2} }
...
func (*GetSessionEntityTypeRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{3} }
...
func (*CreateSessionEntityTypeRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{4} }
...
func (*UpdateSessionEntityTypeRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{5} }
...
func (*DeleteSessionEntityTypeRequest) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{6} }
...
func init() {
	proto.RegisterFile("google/cloud/dialogflow/v2beta1/session_entity_type.proto", fileDescriptor4)
}
